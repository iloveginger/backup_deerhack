...
const TracksCard = () => {
    const [selectedTrack, setSelectedTrack] = useState<string>("Interactive Technology");
    ...
    const trackData = [
        {
            ...
            headStyling: selectedTrack === "Interactive Technology" ? "bg-grape text-magnolia active" : "bg-violet hover:bg-grape hover:text-magnolia",
            bodyStyling: "bg-grape text-magnolia",
            description: "The track is about the development of interactive technology and its applications in various fields."
        },
        {
            title: "Data Science / Machine Learning",
            svg: <DataScienceSVG height={25} width={25} />,
            svgBody: <DataScienceSVG height={50} width={50} />,
            headStyling: selectedTrack === "Data Science / Machine Learning" ? "bg-purpures text-magnolia active" : "bg-violet hover:bg-purpures hover:text-magnolia",
            bodyStyling: "bg-purpures text-magnolia",
            description: "The track is about the development of data science and machine learning and their applications in various fields."
        },
        {
            title: "Blockchain",
            svg: <BlockchainSVG height={25} width={25} />,
            svgBody: <BlockchainSVG height={50} width={50} />,
            headStyling: selectedTrack === "Blockchain" ? "bg-magnolia text-dark-purple active" : "bg-violet hover:bg-magnolia hover:text-dark-purple",
            bodyStyling: "bg-magnolia text-dark-purple",
            description: "The track is about the development of blockchain technology and its applications in various fields."
        },
        {
            title: "Open Innovation",
            svg: <OpenInnovationSVG height={25} width={25} />,
            svgBody: <OpenInnovationSVG height={50} width={50} />,
            headStyling: selectedTrack === "Open Innovation" ? "bg-secondary text-dark-purple active" : "bg-violet hover:bg-secondary hover:text-dark-purple",
            bodyStyling: "bg-secondary text-dark-purple",
            description: "The track is about fostering open innovation and collaboration across various domains."
        }
    ];
