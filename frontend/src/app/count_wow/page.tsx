...
export default async function Page(){
    ...
    const nepal_time = new Date().toLocaleTimeString('en-US',{timeZone:"Asia/Kathmandu"})

    return (
        <div className={`flex justify-center mt-[20%] headings color-white ${cabinetBlack}`}>
            <h1>Participant Count as of {nepal_time} is <div className="font-black">{participant_count}</div> </h1>
        </div>
    )
}