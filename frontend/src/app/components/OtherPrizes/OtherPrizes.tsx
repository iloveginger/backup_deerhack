...
export default function OtherPrizes({
  ...
  return (
      <div className="flex justify-start items-start ml-[2rem] md:ml-0">
        ...
        <div className="flex justify-center max-w-[10rem] relative top-[1.9rem] right-[2rem]">{svg}</div>
          <div
            // className={`${cabinetExtraBold.className} text-primary-gradient-color text-2xl sm:text-2xl lg:text-4xl text-start md:text-end`}
            className={`${cabinetExtraBold.className} text-primary-gradient-color text-2xl text-start w-[8rem] md:text-end md:text-4xl md:h-full md:w-full relative right-[4.3rem] top-[1.3rem] leading-none text-[1.701rem]`}
          >
            Tons of 
            Gifts & <br/> 
