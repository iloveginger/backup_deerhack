...
const Navbar = () => {
  ...
  return (
    <nav
      className={`flex flex-row justify-between gap-5 py-4 lg:px-[120px]  items-start ${
    ...
    >
      ...
      <div
        className={`lg:flex lg:items-start ${
          isMenuOpen ? cabinetMedium.className + " block mt-5" : "hidden"
        } `}
      >
        <Counter />
      </div>
      ...
      <div
        ...
        } lg:flex-row lg:items-start mt-4 lg:gap-10  ${
          isMenuOpen
