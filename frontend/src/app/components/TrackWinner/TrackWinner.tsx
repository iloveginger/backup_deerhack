...
export default function TrackWinner(): ReactElement {
  return (
    <div
      className={`primary-gradient-background w-full sm:w-64 lg:w-[22rem] p-[2px] sm:h-[16rem] md:h-62 rounded-[0.9rem]`}
    >
      <div
        className={`bg-violet flex flex-col h-full w-full rounded-[0.8rem] justify-start pt-10 gap-10 pb-20`}
      >
